...
export default async function AccountPage() {
  ...
  return (
    <main className="w-full mx-auto max-w-lg pb-28 pt-8">
      <h1 className="mb-6 px-4 text-2xl font-bold tracking-tight">Account</h1>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-3 rounded-xl px-1 py-2.5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground/70">Always available</p>
              </div>
            </div>
