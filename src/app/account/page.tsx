...
export default async function AccountPage() {
  ...
  const hasGoogle = !user; // no credentials row = signed up via Google
  ...
  return (
    <div className="min-h-screen">
      <header className="sticky top-0 z-10 border-b bg-background/95 backdrop-blur-sm supports-backdrop-filter:bg-background/80">
        <div className="mx-auto flex max-w-lg items-center gap-3 px-5 py-3 [padding-top:max(0.75rem,env(safe-area-inset-top))]">
          <Link
            href="/"
          ...
          <h1 className="text-base font-semibold tracking-tight">Account</h1>
        </div>
      </header>

    <main className="w-full mx-auto max-w-lg pb-28 pt-6">
      <div className="flex flex-col gap-3 px-3">
        {/* Profile */}
        <div className="rounded-2xl border bg-card px-5 py-4">
          <p className="mb-0.5 text-xs text-muted-foreground/60">Signed in as</p>
        ...
        <div className="rounded-2xl border bg-card px-5 py-4">
          ...
          <div className="flex flex-col gap-1">
            {/* Google — only shown for Google-authenticated users */}
            {hasGoogle && (
              <>
                <div className="flex items-center gap-3 rounded-xl px-1 py-2.5">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground/70">Linked</p>
                  </div>
                </div>
            ...
            <div className="flex items-start gap-3 rounded-xl px-1 py-2.5">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <span className={`text-xs ${hasPassword ? "text-muted-foreground/70" : "text-amber-600 dark:text-amber-400"}`}>
